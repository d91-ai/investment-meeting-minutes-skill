...
```text
请使用 investment-meeting-minutes Skill，整理 20260801-华鑫周会.docx。

这是会议原始文稿，按“多人复盘会”处理。保留原始发言顺序、发言人和第一人称，修正明显转写错误，核验公司名称和股票代码，无法确认的内容列入存疑表。

严格执行完整审核链，审核未完成不得导出。最终输出为 2026-08-01 - 华鑫周会.md，保存到桌面。
```
